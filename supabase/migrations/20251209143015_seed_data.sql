...
-- Generated on 2025-12-09T07:29:55.173Z

-- Insert Users
INSERT INTO "User" (name, email, password, role, "createdAt", "updatedAt") VALUES
('Admin User', 'admin@sjrental.com', '$2b$10$Wh/thFM/2NcuVojsVrlMqOoQbsKiwIWTlELNQK3OEzQd.nMgTZlUW', 'ADMIN', NOW(), NOW()),
('Customer Demo', 'customer@example.com', '$2b$10$/g8e/AIy7RSeil53sz7ug.iLGxDxXjCBGuPCyui.O9PUDB15sC.oG', 'CUSTOMER', NOW(), NOW())
